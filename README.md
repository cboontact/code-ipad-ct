...
### 📦 8.4 กระบวนการรับเครื่อง

1. ครูที่ลงทะเบียนเลือกรับ iPad จะอยู่ในสถานะ **พร้อมรับเครื่อง**
2. ผู้ดูแลเปิดเมนู **สถานะรับเครื่องครู** แล้วค้นหาหรือกรองตามกลุ่มสาระ
3. ตรวจชื่อและเครื่อง แล้วกดยืนยันรับเครื่อง โดย Serial Number เป็นข้อมูลเสริมและไม่บังคับ
4. เมื่อยืนยันแล้ว ครูจะเปลี่ยนเป็น **รับเครื่องแล้ว** และปรากฏในเมนู **คืน iPad**
5. นักเรียนใช้กระบวนการเดียวกัน แต่ต้องผ่านการอนุมัติและตรวจรับเอกสาร AWAT-03 ก่อน

ข้อมูลจัดสรรเครื่องกับสถานะรับเครื่องเป็นคนละส่วน การกรอก Serial Number เพียงอย่างเดียวยังไม่ถือว่าส่งมอบเครื่องแล้ว

### 🔁 8.5 กระบวนการคืน iPad
...
### 📦 12.6 สถานะการรับเครื่อง

**ครูและบุคลากร** ใช้เมนู **สถานะรับเครื่องครู** เพื่อค้นหา ตรวจตามกลุ่มสาระ หรือดูประวัติการรับ–คืน ครูจะรับเครื่องได้เมื่อส่งคำตอบเลือกรับ iPad แล้ว

**นักเรียน** ใช้เมนู **สถานะรับเครื่องนักเรียน** เพื่อค้นหาด่วนด้วยรหัสนักเรียน ตรวจรายห้อง หรือดูประวัติ นักเรียนจะรับเครื่องได้หลังลงทะเบียน ผ่านการอนุมัติ และตรวจรับเอกสารแล้ว

เมื่อบันทึกรับเครื่อง ผู้รับจะปรากฏในเมนู **คืน iPad** โดยอัตโนมัติ เมื่อรับคืนแล้วสถานะทั้งสองเมนูจะเปลี่ยนเป็น **คืนเครื่องแล้ว** พร้อมบันทึกผู้ดำเนินการและประวัติ ไม่ควรลบหรือเปิดลงทะเบียนใหม่ขณะที่ยังถือเครื่องอยู่

ในเมนู **ตรวจรับเอกสาร** ผู้ดูแลสูงสุดสามารถกด **เลือกยกเลิกหลายคน** เลือกรายการที่รับเอกสารแล้วได้สูงสุด 50 คนต่อครั้ง และระบุเหตุผลร่วมกัน ระบบยังคงสร้างประวัติแยกรายบุคคล และจะไม่อนุญาตให้ยกเลิกชุดที่มีนักเรียนรับเครื่องไปแล้ว
