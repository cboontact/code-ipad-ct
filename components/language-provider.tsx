...
const translations: Record<string, string> = {
  ...
  "เลขประจำตัวประชาชน / รหัส G / Passport": "Thai citizen ID / G-code / Passport",
  "เลขประจำตัวประชาชน / Passport": "Thai citizen ID / Passport",
  "เลข 13 หลัก รหัส G หรือ Passport": "13-digit ID, G-code, or Passport",
  "เลขประจำตัวไม่ถูกต้อง กรุณาตรวจเลขคนไทย 13 หลัก รหัส G เลขต่างด้าว หรือ Passport": "Invalid ID. Check the 13-digit Thai citizen ID, G-code, foreign ID, or Passport.",
  ...
  "ท่านมีความประสงค์รับ iPad": "Would you like to receive an iPad",
  "ตามโครงการหรือไม่": "under this project?",
  ...
  "ตรวจสอบและกรอกข้อมูลให้ครบ ระบบจะบันทึกกลับไปยังรายชื่อครู": "Review and complete the information. The system will update your teacher record.",
  "ตำแหน่ง": "Position",
  "วิทยฐานะ": "Academic rank",
  "เลือกตำแหน่ง": "Select a position",
  "เลือกวิทยฐานะ": "Select an academic rank",
  "ผู้บริหาร": "School administrator",
  "ครูอัตราจ้าง": "Contract teacher",
  "ไม่มีวิทยฐานะ": "No academic rank",
  "ชำนาญการ": "Senior Professional Level",
  "ชำนาญการพิเศษ": "Senior Professional Level (Advanced)",
  "เชี่ยวชาญ": "Expert Level",
  "เชี่ยวชาญพิเศษ": "Advisory Level",
  "คำนำหน้า": "Title",
  "ชื่อ": "First name",
  "นามสกุล": "Last name",
  ...
  "ประวัติ": "History",
  "สถานะ": "Status",
  "สถานะรายชื่อ": "Record status",
  "เปิดใช้งาน": "Active",
  "ปิดใช้งาน": "Inactive",
  "เปิดใช้งานรายชื่อนักเรียน": "Student record active",
  "ปิดใช้งานรายชื่อนักเรียน": "Student record inactive",
  "วันที่": "Date",
  ...
  "ท่านยืนยันความประสงค์": "Please confirm your selection",
  "ในชื่อ": "for",
  "กลับไปตรวจสอบ": "Back to review",
  "ยืนยันบันทึก": "Confirm and save",
  "บันทึกเมื่อ": "Submitted on",
  "น.": "",
  "ระบบจัดเก็บข้อมูลส่วนบุคคลแบบเข้ารหัสและไม่แสดงต่อสาธารณะ": "Personal information is encrypted and is not displayed publicly.",
  "สำหรับผู้แจ้งไม่รับ iPad": "For those declining an iPad",
  "ความประสงค์ของท่าน": "Your selection",
  "คำแนะนำก่อนแจ้งไม่รับ iPad": "Guidance before declining an iPad",
  "กรุณารับอุปกรณ์และเปิดใช้งาน NDLP ก่อน": "Please receive the device and activate NDLP first",
  "รับ iPad และดำเนินการต่อ": "Receive iPad and continue",
  "ใช้สำหรับจัดทำเอกสารการรับอุปกรณ์เท่านั้น": "Used only to prepare the device receipt document.",
  "กรอกข้อมูลให้ครบถ้วนเพื่อใช้ในแบบฟอร์ม AWAT03": "Complete the information for the AWAT-03 form.",
  "การคุ้มครองข้อมูลส่วนบุคคล": "Personal data protection",
  "ข้าพเจ้ารับทราบว่าข้อมูลจะใช้เพื่อดำเนินโครงการและจัดทำเอกสารรับอุปกรณ์ โดยจัดเก็บในรูปแบบเข้ารหัส": "I acknowledge that this information will be encrypted and used to administer the project and prepare device receipt documents.",
  "อำเภอ/เขต": "District",
  "ตำบล/แขวง": "Subdistrict",
  "เลือกจังหวัด": "Select a province",
  "เลือกอำเภอ": "Select a district",
  "เลือกตำบล": "Select a subdistrict",
  "เจ้าหน้าที่และครูต่างชาติไม่จำเป็นต้องกรอกอีเมล NDLP": "NDLP email is optional for staff and international teachers.",
  "นักเรียนต่างชาติไม่จำเป็นต้องกรอกอีเมล NDLP": "NDLP email is optional for international students.",
  "(ไม่บังคับ)": "(Optional)",
  "คำแนะนำสำหรับนักเรียนมัธยมศึกษาตอนปลาย": "Guidance for upper-secondary students",
  "ขอความอนุเคราะห์รับ iPad และเปิดใช้งาน NDLP ก่อน": "Please receive the iPad and activate NDLP first",
  "เบอร์โทรศัพท์นักเรียน": "Student phone number",
  "รหัสนักเรียน": "Student ID",
  "ชื่อ-นามสกุลผู้ปกครอง (รวมคำนำหน้า)": "Guardian's full name (including title)",
  "กรอกชื่อพร้อมคำนำหน้า ระบบจะแยกข้อมูลให้อัตโนมัติ": "Enter the full name with a title; the system will separate it automatically.",
  "ตรวจพบคำนำหน้า": "Detected title",
  "กรุณาขึ้นต้นด้วย นาย นาง หรือนางสาว และกรอกชื่อ-นามสกุลให้ครบ": "Begin with Mr., Mrs., or Ms. and enter the complete name.",
  "ข้อมูลจะปรากฏในเอกสาร AWAT-03": "This information will appear on the AWAT-03 form.",
  "รับทราบว่าข้อมูลนี้ใช้เพื่อดำเนินโครงการและจัดทำเอกสาร AWAT-03 เท่านั้น": "I acknowledge that this information will only be used for the project and AWAT-03 documents.",
  "ยืนยันการลงทะเบียน": "Confirm registration",
  "ผู้ปกครอง": "Parent/Guardian",
  "กรุณาตรวจสอบชื่อผู้ปกครองให้ถูกต้องก่อนบันทึก": "Verify the guardian's name before saving.",
  "คนไทยตรวจสอบเลข 13 หลักตามหลักการ และรองรับรหัส G เลขบุคคลไม่มีสัญชาติไทย หรือ Passport": "Thai IDs use the official 13-digit checksum. G-codes, non-Thai IDs, and passports are also supported.",
  "กรุณาลองใหม่": "Please try again",
  "ข้อมูลไม่ถูกต้อง": "Invalid information.",
  "จาก": "of",
  "คน ลงทะเบียนแล้ว": "people registered",
  "หมายเหตุ:": "Note:",
  "ชั้น": "Grade",
  "· รหัส": "· ID",
  "ขอความอนุเคราะห์ให้รับอุปกรณ์และเปิดใช้งานบัญชี NDLP ให้เรียบร้อยก่อน หากภายหลังยังประสงค์คืนอุปกรณ์ สามารถบันทึกแบบฟอร์มแจ้งคืนได้ภายหลัง": "Please receive the device and activate your NDLP account first. If you later wish to return it, you may submit a device return form.",
