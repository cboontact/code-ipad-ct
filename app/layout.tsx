...
export async function generateMetadata():Promise<Metadata>{
  ...
  return {title:{default:title,template:"%s | โรงเรียนจอมทอง"},description,icons:{icon:"/api/public/logo",shortcut:"/api/public/logo"},openGraph:{title,description,type:"website",locale:"th_TH",images:[{url:`${origin}/og.png`,width:1200,height:630,alt:title}]},twitter:{card:"summary_large_image",title,description,images:[`${origin}/og.png`]}};
}
